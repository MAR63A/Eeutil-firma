...
public class RevocationValuesType {
   ...
   * 
   * @return possible object is {@link RevocationValuesType.CRLValues }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link RevocationValuesType.CRLValues }
   * 
   */
   ...
   * 
   * @return possible object is {@link RevocationValuesType.OCSPValues }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link RevocationValuesType.OCSPValues }
   * 
   */
  ...
  public static class CRLValues {
     ...
     * why there is not a <CODE>set</CODE> method for the verifiedCRL property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link CRLValidityType }
     * 
     * 
     */
  ...
  public static class OCSPValues {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the verifiedOCSPResponse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link OCSPValidityType }
     * 
     * 
     */
