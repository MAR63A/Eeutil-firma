...
@XmlType(name = "ServiceHistoryType", propOrder = {"serviceHistoryInstance"})
public class ServiceHistoryType {
   ...
   * there is not a <CODE>set</CODE> method for the serviceHistoryInstance property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ServiceHistoryInstanceType }
   * 
   * 
   */
