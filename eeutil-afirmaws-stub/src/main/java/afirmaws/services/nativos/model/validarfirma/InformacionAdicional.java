...
@XmlType(name = "", propOrder = {"firmante"})
...
public class InformacionAdicional {
   ...
   * there is not a <CODE>set</CODE> method for the firmante property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link InformacionAdicional.Firmante }
   * 
   * 
   */
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = {"certificado", "selloTiempo", "certificadoTSA"})
