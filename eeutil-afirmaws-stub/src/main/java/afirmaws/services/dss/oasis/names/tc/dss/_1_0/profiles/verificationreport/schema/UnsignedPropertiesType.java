...
import afirmaws.services.dss.org.etsi.uri._01903.v1_3.UnsignedDataObjectPropertiesType;
 ...
 *       &lt;sequence>
 *         &lt;element name="UnsignedSignatureProperties" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}UnsignedSignaturePropertiesType" minOccurs="0"/>
...
@XmlType(name = "UnsignedPropertiesType",
    propOrder = {"unsignedSignatureProperties", "unsignedDataObjectProperties", "other"})
public class UnsignedPropertiesType {
   ...
   * 
   * @return possible object is {@link UnsignedSignaturePropertiesType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link UnsignedSignaturePropertiesType }
   * 
   */
   ...
   * 
   * @return possible object is {@link UnsignedDataObjectPropertiesType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link UnsignedDataObjectPropertiesType }
   * 
   */
