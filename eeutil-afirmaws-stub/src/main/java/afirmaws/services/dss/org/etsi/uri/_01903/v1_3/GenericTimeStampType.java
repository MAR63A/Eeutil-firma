...
import afirmaws.services.dss.org.w3._2000._09.xmldsig.CanonicalizationMethodType;
...
public abstract class GenericTimeStampType {
  ...
  @XmlElements({@XmlElement(name = "EncapsulatedTimeStamp", type = EncapsulatedPKIDataType.class),
   ...
   * there is not a <CODE>set</CODE> method for the include property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link IncludeType }
   * 
   * 
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the referenceInfo property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ReferenceInfoType }
   * 
   * 
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the encapsulatedTimeStampOrXMLTimeStamp property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link EncapsulatedPKIDataType }
   * {@link AnyType }
   * 
   * 
   */
