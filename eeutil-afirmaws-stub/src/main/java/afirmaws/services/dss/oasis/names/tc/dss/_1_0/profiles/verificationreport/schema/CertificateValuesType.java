 ...
 *         &lt;element name="EncapsulatedX509Certificate" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}CertificateValidityType"/>
...
@XmlType(name = "CertificateValuesType",
    propOrder = {"encapsulatedX509CertificateOrOtherCertificate"})
public class CertificateValuesType {

  @XmlElements({@XmlElement(name = "OtherCertificate"),
   ...
   * there is not a <CODE>set</CODE> method for the encapsulatedX509CertificateOrOtherCertificate
   * property.
   * 
   * <p>
