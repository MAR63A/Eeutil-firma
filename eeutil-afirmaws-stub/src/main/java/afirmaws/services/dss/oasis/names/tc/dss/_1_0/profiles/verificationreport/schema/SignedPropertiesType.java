 ...
 *       &lt;sequence>
 *         &lt;element name="SignedSignatureProperties" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}SignedSignaturePropertiesType" minOccurs="0"/>
 *         &lt;element name="SignedDataObjectProperties" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}SignedDataObjectPropertiesType" minOccurs="0"/>
...
@XmlType(name = "SignedPropertiesType",
    propOrder = {"signedSignatureProperties", "signedDataObjectProperties", "other"})
public class SignedPropertiesType {
   ...
   * 
   * @return possible object is {@link SignedSignaturePropertiesType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignedSignaturePropertiesType }
   * 
   */
   ...
   * 
   * @return possible object is {@link SignedDataObjectPropertiesType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignedDataObjectPropertiesType }
   * 
   */
