...
public class ObjectFactory {
  ...
  private final static QName _ReturnSignedDataInfo_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "ReturnSignedDataInfo");
  private final static QName _SignatureArchiveId_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "SignatureArchiveId");
  private final static QName _ReferenceId_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "ReferenceId");
  private final static QName _HashAlgorithm_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "HashAlgorithm");
  private final static QName _XMLSignatureMode_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "XMLSignatureMode");
  private final static QName _ResponseTime_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "ResponseTime");
  private final static QName _TargetSigner_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "TargetSigner");
  private final static QName _DocumentArchiveId_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "DocumentArchiveId");
  private final static QName _ReturnReadableCertificateInfo_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "ReturnReadableCertificateInfo");
  private final static QName _BatchResponse_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", "BatchResponse");
  private final static QName __0020UpdatedSignatureMode_QNAME =
      new QName("urn:afirma:dss:1.0:profile:XSS:schema", " UpdatedSignatureMode");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: afirma.dss._1_0.profile.xss.schema
   * 
   */
   ...
   * 
   */
  @XmlElementDecl(namespace = "urn:afirma:dss:1.0:profile:XSS:schema",
      name = "ReturnSignedDataInfo")
  ...
  public JAXBElement<ArchiveIdType> createSignatureArchiveId(ArchiveIdType value) {
    return new JAXBElement<ArchiveIdType>(_SignatureArchiveId_QNAME, ArchiveIdType.class, null,
        value);
  }
  ...
  public JAXBElement<XMLGregorianCalendar> createResponseTime(XMLGregorianCalendar value) {
    return new JAXBElement<XMLGregorianCalendar>(_ResponseTime_QNAME, XMLGregorianCalendar.class,
        null, value);
  }
  ...
  public JAXBElement<ArchiveIdType> createDocumentArchiveId(ArchiveIdType value) {
    return new JAXBElement<ArchiveIdType>(_DocumentArchiveId_QNAME, ArchiveIdType.class, null,
        value);
  }
   ...
   */
  @XmlElementDecl(namespace = "urn:afirma:dss:1.0:profile:XSS:schema",
      name = "ReturnReadableCertificateInfo")
  ...
  public JAXBElement<BatchResponseType> createBatchResponse(BatchResponseType value) {
    return new JAXBElement<BatchResponseType>(_BatchResponse_QNAME, BatchResponseType.class, null,
        value);
  }
