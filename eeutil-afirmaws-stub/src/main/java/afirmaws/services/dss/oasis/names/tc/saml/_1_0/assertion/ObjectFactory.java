...
public class ObjectFactory {
  ...
  private final static QName _Attribute_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Attribute");
  private final static QName _AttributeStatement_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AttributeStatement");
  private final static QName _Condition_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Condition");
  private final static QName _SubjectConfirmation_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "SubjectConfirmation");
  private final static QName _AudienceRestrictionCondition_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AudienceRestrictionCondition");
  private final static QName _AssertionIDReference_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AssertionIDReference");
  private final static QName _Subject_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Subject");
  private final static QName _Advice_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Advice");
  private final static QName _Action_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Action");
  private final static QName _Audience_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Audience");
  private final static QName _ConfirmationMethod_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "ConfirmationMethod");
  private final static QName _SubjectConfirmationData_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "SubjectConfirmationData");
  private final static QName _SubjectStatement_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "SubjectStatement");
  private final static QName _Assertion_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Assertion");
  private final static QName _NameIdentifier_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "NameIdentifier");
  private final static QName _AuthorizationDecisionStatement_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AuthorizationDecisionStatement");
  private final static QName _AttributeDesignator_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AttributeDesignator");
  private final static QName _AuthorityBinding_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AuthorityBinding");
  private final static QName _Evidence_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Evidence");
  private final static QName _SubjectLocality_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "SubjectLocality");
  private final static QName _AuthenticationStatement_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AuthenticationStatement");
  private final static QName _Conditions_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Conditions");
  private final static QName _DoNotCacheCondition_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "DoNotCacheCondition");
  private final static QName _Statement_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "Statement");
  private final static QName _AttributeValue_QNAME =
      new QName("urn:oasis:names:tc:SAML:1.0:assertion", "AttributeValue");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: oasis.names.tc.saml._1_0.assertion
   * 
   */
  ...
  public JAXBElement<AttributeStatementType> createAttributeStatement(
    ...
    return new JAXBElement<AttributeStatementType>(_AttributeStatement_QNAME,
        AttributeStatementType.class, null, value);
  }
  ...
  public JAXBElement<ConditionAbstractType> createCondition(ConditionAbstractType value) {
    return new JAXBElement<ConditionAbstractType>(_Condition_QNAME, ConditionAbstractType.class,
        null, value);
  }
  ...
  public JAXBElement<SubjectConfirmationType> createSubjectConfirmation(
      SubjectConfirmationType value) {
    return new JAXBElement<SubjectConfirmationType>(_SubjectConfirmation_QNAME,
        SubjectConfirmationType.class, null, value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link AudienceRestrictionConditionType
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "urn:oasis:names:tc:SAML:1.0:assertion",
      name = "AudienceRestrictionCondition")
  public JAXBElement<AudienceRestrictionConditionType> createAudienceRestrictionCondition(
      AudienceRestrictionConditionType value) {
    return new JAXBElement<AudienceRestrictionConditionType>(_AudienceRestrictionCondition_QNAME,
        AudienceRestrictionConditionType.class, null, value);
  }
  ...
  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link SubjectStatementAbstractType
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "urn:oasis:names:tc:SAML:1.0:assertion", name = "SubjectStatement")
  public JAXBElement<SubjectStatementAbstractType> createSubjectStatement(
      SubjectStatementAbstractType value) {
    return new JAXBElement<SubjectStatementAbstractType>(_SubjectStatement_QNAME,
        SubjectStatementAbstractType.class, null, value);
  }
  ...
  public JAXBElement<NameIdentifierType> createNameIdentifier(NameIdentifierType value) {
    return new JAXBElement<NameIdentifierType>(_NameIdentifier_QNAME, NameIdentifierType.class,
        null, value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link AuthorizationDecisionStatementType
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "urn:oasis:names:tc:SAML:1.0:assertion",
      name = "AuthorizationDecisionStatement")
  public JAXBElement<AuthorizationDecisionStatementType> createAuthorizationDecisionStatement(
      AuthorizationDecisionStatementType value) {
    return new JAXBElement<AuthorizationDecisionStatementType>(
        _AuthorizationDecisionStatement_QNAME, AuthorizationDecisionStatementType.class, null,
        value);
  }
  ...
  public JAXBElement<AttributeDesignatorType> createAttributeDesignator(
      AttributeDesignatorType value) {
  ...
  public JAXBElement<AuthorityBindingType> createAuthorityBinding(AuthorityBindingType value) {
    return new JAXBElement<AuthorityBindingType>(_AuthorityBinding_QNAME,
        AuthorityBindingType.class, null, value);
  }
  ...
  public JAXBElement<SubjectLocalityType> createSubjectLocality(SubjectLocalityType value) {
    return new JAXBElement<SubjectLocalityType>(_SubjectLocality_QNAME, SubjectLocalityType.class,
        null, value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link AuthenticationStatementType
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "urn:oasis:names:tc:SAML:1.0:assertion",
      name = "AuthenticationStatement")
  public JAXBElement<AuthenticationStatementType> createAuthenticationStatement(
      AuthenticationStatementType value) {
    return new JAXBElement<AuthenticationStatementType>(_AuthenticationStatement_QNAME,
        AuthenticationStatementType.class, null, value);
  }
  ...
  public JAXBElement<DoNotCacheConditionType> createDoNotCacheCondition(
      DoNotCacheConditionType value) {
    return new JAXBElement<DoNotCacheConditionType>(_DoNotCacheCondition_QNAME,
        DoNotCacheConditionType.class, null, value);
  }
  ...
  public JAXBElement<StatementAbstractType> createStatement(StatementAbstractType value) {
    return new JAXBElement<StatementAbstractType>(_Statement_QNAME, StatementAbstractType.class,
        null, value);
  }
