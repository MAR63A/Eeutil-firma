...
public class RequestValidarFirmaDSS extends RequestConfigAfirma {

  private byte[] sign;
  private DSSSignerProcessor processor;
  private byte[] content;

  public RequestValidarFirmaDSS(RequestConfigAfirma config, byte[] sign,
      DSSSignerProcessor processor, byte[] content) {
