...
@XmlType(name = "", propOrder = {"checkOptions", "reportOptions"})
...
public class ReturnVerificationReport {
   ...
   * 
   * @return possible object is {@link CheckOptionsType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CheckOptionsType }
   * 
   */
   ...
   * 
   * @return possible object is {@link ReportOptionsType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link ReportOptionsType }
   * 
   */
