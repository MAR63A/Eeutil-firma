...
import es.mpt.dsic.inside.ws.service.EeUtilFirmarService;
...
@Service("eeUtilFirmarService")
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.EeUtilFirmarService")
@SOAPBinding(style = Style.RPC, parameterStyle = ParameterStyle.BARE, use = Use.LITERAL)

public class EeUtilFirmarServiceImpl implements EeUtilFirmarService {
  ...
  @Override
  public DatosSalida firmaFichero(ApplicationLogin info, DatosEntradaFichero entrada) {
  ...
  @Override
  public DatosSalida firmaFicheroWithPropertie(ApplicationLogin info, DatosEntradaFichero entrada) {
    DatosSalida salida = null;
    try {
