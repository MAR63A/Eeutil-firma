...
public class ObjectFactory {
  ...
  private final static QName _PostalAddresses_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "PostalAddresses");
  private final static QName _PointersToOtherTSL_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "PointersToOtherTSL");
  private final static QName _ServiceTypeIdentifier_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ServiceTypeIdentifier");
  private final static QName _SchemeInformation_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "SchemeInformation");
  private final static QName _TrustServiceStatusList_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "TrustServiceStatusList");
  private final static QName _ServiceHistory_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ServiceHistory");
  private final static QName _ServiceStatus_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ServiceStatus");
  private final static QName _TSPService_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "TSPService");
  private final static QName _OtherTSLPointer_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "OtherTSLPointer");
  private final static QName _ElectronicAddress_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ElectronicAddress");
  private final static QName _ServiceDigitalIdentity_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ServiceDigitalIdentity");
  private final static QName _TSPServices_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "TSPServices");
  private final static QName _Extension_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "Extension");
  private final static QName _PostalAddress_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "PostalAddress");
  private final static QName _PolicyOrLegalNotice_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "PolicyOrLegalNotice");
  private final static QName _ServiceSupplyPoints_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ServiceSupplyPoints");
  private final static QName _NextUpdate_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "NextUpdate");
  private final static QName _SchemeTerritory_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "SchemeTerritory");
  private final static QName _TrustServiceProvider_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "TrustServiceProvider");
  private final static QName _ServiceInformation_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ServiceInformation");
  private final static QName _TrustServiceProviderList_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "TrustServiceProviderList");
  private final static QName _ServiceHistoryInstance_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "ServiceHistoryInstance");
  private final static QName _TSPInformation_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "TSPInformation");
  private final static QName _AdditionalInformation_QNAME =
      new QName("http://uri.etsi.org/02231/v2#", "AdditionalInformation");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: org.etsi.uri._02231.v2
   * 
   */
  ...
  public JAXBElement<PostalAddressListType> createPostalAddresses(PostalAddressListType value) {
    return new JAXBElement<PostalAddressListType>(_PostalAddresses_QNAME,
        PostalAddressListType.class, null, value);
  }
  ...
  public JAXBElement<OtherTSLPointersType> createPointersToOtherTSL(OtherTSLPointersType value) {
    return new JAXBElement<OtherTSLPointersType>(_PointersToOtherTSL_QNAME,
        OtherTSLPointersType.class, null, value);
  }
  ...
  public JAXBElement<TSLSchemeInformationType> createSchemeInformation(
      TSLSchemeInformationType value) {
    return new JAXBElement<TSLSchemeInformationType>(_SchemeInformation_QNAME,
        TSLSchemeInformationType.class, null, value);
  }
  ...
  public JAXBElement<TrustStatusListType> createTrustServiceStatusList(TrustStatusListType value) {
    return new JAXBElement<TrustStatusListType>(_TrustServiceStatusList_QNAME,
        TrustStatusListType.class, null, value);
  }
  ...
  public JAXBElement<ServiceHistoryType> createServiceHistory(ServiceHistoryType value) {
    return new JAXBElement<ServiceHistoryType>(_ServiceHistory_QNAME, ServiceHistoryType.class,
        null, value);
  }
  ...
  public JAXBElement<OtherTSLPointerType> createOtherTSLPointer(OtherTSLPointerType value) {
    return new JAXBElement<OtherTSLPointerType>(_OtherTSLPointer_QNAME, OtherTSLPointerType.class,
        null, value);
  }
  ...
  public JAXBElement<ElectronicAddressType> createElectronicAddress(ElectronicAddressType value) {
    return new JAXBElement<ElectronicAddressType>(_ElectronicAddress_QNAME,
        ElectronicAddressType.class, null, value);
  }
  ...
  public JAXBElement<DigitalIdentityListType> createServiceDigitalIdentity(
      DigitalIdentityListType value) {
    return new JAXBElement<DigitalIdentityListType>(_ServiceDigitalIdentity_QNAME,
        DigitalIdentityListType.class, null, value);
  }
  ...
  public JAXBElement<TSPServicesListType> createTSPServices(TSPServicesListType value) {
    return new JAXBElement<TSPServicesListType>(_TSPServices_QNAME, TSPServicesListType.class, null,
        value);
  }
  ...
  public JAXBElement<PostalAddressType> createPostalAddress(PostalAddressType value) {
    return new JAXBElement<PostalAddressType>(_PostalAddress_QNAME, PostalAddressType.class, null,
        value);
  }
  ...
  public JAXBElement<PolicyOrLegalnoticeType> createPolicyOrLegalNotice(
      PolicyOrLegalnoticeType value) {
    return new JAXBElement<PolicyOrLegalnoticeType>(_PolicyOrLegalNotice_QNAME,
        PolicyOrLegalnoticeType.class, null, value);
  }
  ...
  public JAXBElement<ServiceSupplyPointsType> createServiceSupplyPoints(
      ServiceSupplyPointsType value) {
    return new JAXBElement<ServiceSupplyPointsType>(_ServiceSupplyPoints_QNAME,
        ServiceSupplyPointsType.class, null, value);
  }
  ...
  public JAXBElement<TSPServiceInformationType> createServiceInformation(
      TSPServiceInformationType value) {
    return new JAXBElement<TSPServiceInformationType>(_ServiceInformation_QNAME,
        TSPServiceInformationType.class, null, value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link TrustServiceProviderListType
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://uri.etsi.org/02231/v2#", name = "TrustServiceProviderList")
  public JAXBElement<TrustServiceProviderListType> createTrustServiceProviderList(
      TrustServiceProviderListType value) {
    return new JAXBElement<TrustServiceProviderListType>(_TrustServiceProviderList_QNAME,
        TrustServiceProviderListType.class, null, value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link ServiceHistoryInstanceType
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://uri.etsi.org/02231/v2#", name = "ServiceHistoryInstance")
  public JAXBElement<ServiceHistoryInstanceType> createServiceHistoryInstance(
      ServiceHistoryInstanceType value) {
    return new JAXBElement<ServiceHistoryInstanceType>(_ServiceHistoryInstance_QNAME,
        ServiceHistoryInstanceType.class, null, value);
  }
  ...
  public JAXBElement<TSPInformationType> createTSPInformation(TSPInformationType value) {
    return new JAXBElement<TSPInformationType>(_TSPInformation_QNAME, TSPInformationType.class,
        null, value);
  }
  ...
  public JAXBElement<AdditionalInformationType> createAdditionalInformation(
      AdditionalInformationType value) {
    return new JAXBElement<AdditionalInformationType>(_AdditionalInformation_QNAME,
