...
/**
 * <p>
 * Java class for SignedDataRefsType complex type.
 * 
 * <p>
...
@XmlType(name = "SignedDataRefsType", propOrder = {"signedDataRef"})
public class SignedDataRefsType {
   ...
   * there is not a <CODE>set</CODE> method for the signedDataRef property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link SignedDataRefType }
   * 
   * 
   */
