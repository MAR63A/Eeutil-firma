...
public class VerificationTimeInfoType {
   ...
   * there is not a <CODE>set</CODE> method for the additionalTimeInfo property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link AdditionalTimeInfoType }
   * 
   * 
   */
