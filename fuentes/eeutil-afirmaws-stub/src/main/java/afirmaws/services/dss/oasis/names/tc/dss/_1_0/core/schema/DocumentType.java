...
@XmlType(name = "DocumentType",
    propOrder = {"inlineXML", "base64XML", "escapedXML", "base64Data", "attachmentReference"})
public class DocumentType extends DocumentBaseType {
   ...
   * 
   * @param value allowed object is {@link InlineXMLType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link Base64Data }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link AttachmentReferenceType }
   * 
   */
