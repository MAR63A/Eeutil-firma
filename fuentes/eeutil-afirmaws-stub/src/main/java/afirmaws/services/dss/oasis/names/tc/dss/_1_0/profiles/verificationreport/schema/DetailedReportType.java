...
import afirmaws.services.dss.oasis.names.tc.dss._1_0.core.schema.VerifyManifestResultsType;


/**
 * <p>
 * Java class for DetailedReportType complex type.
 * 
 * <p>
...
@XmlType(name = "DetailedReportType", propOrder = {"formatOK", "properties",
    "verifyManifestResults", "signatureOK", "certificatePathValidity"})
public class DetailedReportType {
   ...
   * 
   * @return possible object is {@link VerifyManifestResultsType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link VerifyManifestResultsType }
   * 
   */
   ...
   * 
   * @return possible object is {@link CertificatePathValidityType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CertificatePathValidityType }
   * 
   */
