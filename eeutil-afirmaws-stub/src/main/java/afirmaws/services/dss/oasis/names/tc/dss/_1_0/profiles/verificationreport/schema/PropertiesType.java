 ...
 *         &lt;element name="UnsignedProperties" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}UnsignedPropertiesType" minOccurs="0"/>
 *       &lt;/sequence>
...
public class PropertiesType {
   ...
   * 
   * @return possible object is {@link SignedPropertiesType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignedPropertiesType }
   * 
   */
   ...
   * 
   * @return possible object is {@link UnsignedPropertiesType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link UnsignedPropertiesType }
   * 
   */
