...
@XmlType(name = "CRLContentType", propOrder = {"version", "signature", "issuer", "thisUpdate",
...
public class CRLContentType {
   ...
   * 
   * @return possible object is {@link CRLContentType.RevokedCertificates }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CRLContentType.RevokedCertificates }
   * 
   */
  ...
  public static class RevokedCertificates {
    ...
    @XmlElements({@XmlElement(name = "UserCertificate", type = BigInteger.class),
     ...
     * userCertificateAndRevocationDateAndCrlEntryExtensions property.
     * 
     * <p>
     ...
     * {@link ExtensionsType } {@link XMLGregorianCalendar }
     * 
     * 
     */
