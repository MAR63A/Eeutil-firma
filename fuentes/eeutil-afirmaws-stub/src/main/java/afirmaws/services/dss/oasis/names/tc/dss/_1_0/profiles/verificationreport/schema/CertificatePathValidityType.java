...
@XmlType(name = "CertificatePathValidityType",
    propOrder = {"pathValiditySummary", "certificateIdentifier", "pathValidityDetail"})
public class CertificatePathValidityType {
   ...
   * 
   * @return possible object is {@link CertificatePathValidityDetailType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CertificatePathValidityDetailType }
   * 
   */
