...
@XmlType(name = "TSLSchemeInformationType",
    propOrder = {"tslVersionIdentifier", "tslSequenceNumber", "tslType", "schemeOperatorName",
        ...
        "listIssueDateTime", "nextUpdate", "schemeExtensions"})
public class TSLSchemeInformationType {
   ...
   * 
   * @return possible object is {@link NonEmptyURIListType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link NonEmptyURIListType }
   * 
   */
   ...
   * 
   * @return possible object is {@link PolicyOrLegalnoticeType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link PolicyOrLegalnoticeType }
   * 
   */
   ...
   * 
   * @return possible object is {@link OtherTSLPointersType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link OtherTSLPointersType }
   * 
   */
   ...
   * 
   * @return possible object is {@link NextUpdateType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link NextUpdateType }
   * 
   */
