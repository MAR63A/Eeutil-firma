...
import afirmaws.services.dss.org.etsi.uri._01903.v1_3.CertIDListType;
import afirmaws.services.dss.org.etsi.uri._01903.v1_3.SignaturePolicyIdType;
...
@XmlType(name = "SignedSignaturePropertiesType", propOrder = {"signingTime", "signingCertificate",
...
public class SignedSignaturePropertiesType {
   ...
   * 
   * @return possible object is {@link CertIDListType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CertIDListType }
   * 
   */
   ...
   * 
   * @return possible object is {@link SignaturePolicyIdType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignaturePolicyIdType }
   * 
   */
   ...
   * 
   * @return possible object is {@link SignerRoleType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignerRoleType }
   * 
   */
