...
@XmlType(name = "AttributeCertificateValidityType",
    propOrder = {"attributeCertificateIdentifier", "attributeCertificateValue",
        "attributeCertificateContent", "signatureOK", "certificatePathValidity"})
public class AttributeCertificateValidityType {
   ...
   * 
   * @return possible object is {@link AttrCertIDType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link AttrCertIDType }
   * 
   */
   ...
   * 
   * @return possible object is {@link AttributeCertificateContentType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link AttributeCertificateContentType }
   * 
   */
