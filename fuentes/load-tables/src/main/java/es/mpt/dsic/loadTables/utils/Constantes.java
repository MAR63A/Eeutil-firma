...
public class Constantes {
  ...
  // etiquetas OFICINA
  public static String ETIQUETA_OFICINA = "tns:oficina";
  public static final String ETIQUETA_CODIGO_OFICINA = "tns:codigo";
  public static final String ETIQUETA_NOMBRE_OFICINA = "tns:denominacion";
  public static final String ETIQUETA_NIVEL_ADMINISTRACION_OFICINA = "tns:nivelAdministracion";
  public static final String ETIQUETA_CODIGO_UNIDAD_SUPERIOR_JERARQUICA_OFICINA =
      "tns:codUOResponsable";
  public static final String ETIQUETA_DENOMINACION_UNIDAD_SUPERIOR_JERARQUICA_OFICINA =
      "tns:denUOResponsable";
  public static final String ETIQUETA_CODIGO_OFICINA_RAIZ = "tns:codOFIResponsable";
  public static final String ETIQUETA_DENOMINACION_OFICINA_RAIZ = "tns:denOFIResponsable";
