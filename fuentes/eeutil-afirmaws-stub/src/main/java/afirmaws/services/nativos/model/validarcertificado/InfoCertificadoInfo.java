...
/**
 * <p>
 * Java class for InfoCertificadoInfo complex type.
 * 
 * <p>
...
@XmlType(name = "InfoCertificadoInfo", propOrder = {"campo"})
public class InfoCertificadoInfo {
   ...
   * there is not a <CODE>set</CODE> method for the campo property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link InfoCertificadoInfo.Campo }
   * 
   * 
   */
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = {"idCampo", "valorCampo"})
