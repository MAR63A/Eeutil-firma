...
import afirmaws.services.dss.org.etsi.uri._01903.v1_3.CommitmentTypeIndicationType;
import afirmaws.services.dss.org.etsi.uri._01903.v1_3.DataObjectFormatType;
 ...
 *         &lt;element name="AllDataObjectsTimeStamp" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}TimeStampValidityType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="IndividualDataObjectsTimeStamp" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}TimeStampValidityType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "SignedDataObjectPropertiesType", propOrder = {"dataObjectFormat",
...
public class SignedDataObjectPropertiesType {
   ...
   * there is not a <CODE>set</CODE> method for the dataObjectFormat property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link DataObjectFormatType }
   * 
   * 
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the commitmentTypeIndication property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link CommitmentTypeIndicationType }
   * 
   * 
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the allDataObjectsTimeStamp property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TimeStampValidityType }
   * 
   * 
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the individualDataObjectsTimeStamp property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
