...
import afirmaws.services.dss.org.w3._2000._09.xmldsig.KeyValueType;
...
@XmlType(name = "DigitalIdentityType",
    propOrder = {"x509Certificate", "x509SubjectName", "keyValue", "x509SKI", "other"})
public class DigitalIdentityType {
   ...
   * 
   * @return possible object is {@link KeyValueType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link KeyValueType }
   * 
   */
