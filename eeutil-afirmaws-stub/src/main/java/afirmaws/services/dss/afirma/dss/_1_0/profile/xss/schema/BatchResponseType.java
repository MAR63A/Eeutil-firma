...
@XmlType(name = "BatchResponseType", propOrder = {"responses"})
public class BatchResponseType extends ResponseBaseType {
   ...
   * 
   * @return possible object is {@link Responses }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link Responses }
   * 
   */
