...
/**
 * <p>
 * Java class for ValidacionEstadoInfo complex type.
 * 
 * <p>
...
@XmlType(name = "ValidacionEstadoInfo",
    propOrder = {"estado", "descEstado", "infoMetodoVerificacion"})
public class ValidacionEstadoInfo {
   ...
   * there is not a <CODE>set</CODE> method for the infoMetodoVerificacion property.
   * 
   * <p>
  ...
  public static class InfoMetodoVerificacion {
     ...
     * 
     * @return possible object is {@link ValidacionEstadoInfo.InfoMetodoVerificacion.Metodo }
     * 
     */
     ...
     * 
     * @param value allowed object is {@link ValidacionEstadoInfo.InfoMetodoVerificacion.Metodo }
     * 
     */
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = {"urlServidor", "protocolo"})
