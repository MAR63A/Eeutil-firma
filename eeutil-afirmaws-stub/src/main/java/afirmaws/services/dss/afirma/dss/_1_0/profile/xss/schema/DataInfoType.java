...
import afirmaws.services.dss.oasis.names.tc.dss._1_0.core.schema.DocumentHash;
...
@XmlType(name = "DataInfoType", propOrder = {"contentData", "documentHash", "signedDataRefs"})
public class DataInfoType {
   ...
   * 
   * @return possible object is {@link ContentDataType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link ContentDataType }
   * 
   */
   ...
   * 
   * @return possible object is {@link SignedDataRefsType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignedDataRefsType }
   * 
   */
