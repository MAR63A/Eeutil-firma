...
/**
 * <p>
 * Java class for ValidacionCadenaInfo complex type.
 * 
 * <p>
...
@XmlType(name = "ValidacionCadenaInfo",
    propOrder = {"codigoResultado", "descResultado", "errorCertificado"})
public class ValidacionCadenaInfo {
   ...
   * there is not a <CODE>set</CODE> method for the errorCertificado property.
   * 
   * <p>
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = {"idCertificado", "validacionSimple", "validacionEstado"})
