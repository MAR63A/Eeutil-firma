...
@XmlType(name = "VerifyManifestResultsType", propOrder = {"manifestResult"})
public class VerifyManifestResultsType {
   ...
   * there is not a <CODE>set</CODE> method for the manifestResult property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ManifestResult }
   * 
   * 
   */
