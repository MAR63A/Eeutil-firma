...
@XmlType(name = "AttributeCertificateContentType",
    propOrder = {"version", "holder", "issuer", "signatureAlgorithm", "serialNumber",
        "attCertValidityPeriod", "attributes", "issuerUniqueID", "extensions"})
public class AttributeCertificateContentType {
   ...
   * 
   * @return possible object is {@link ValidityType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link ValidityType }
   * 
   */
   ...
   * 
   * @return possible object is {@link AttributeCertificateContentType.Attributes }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link AttributeCertificateContentType.Attributes }
   * 
   */
