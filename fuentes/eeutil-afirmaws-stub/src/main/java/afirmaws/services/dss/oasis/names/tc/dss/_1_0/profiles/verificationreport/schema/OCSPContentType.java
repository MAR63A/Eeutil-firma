...
@XmlType(name = "OCSPContentType",
    propOrder = {"version", "responderID", "producedAt", "responses", "responseExtensions"})
public class OCSPContentType {
   ...
   * 
   * @return possible object is {@link OCSPContentType.Responses }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link OCSPContentType.Responses }
   * 
   */
  ...
  public static class Responses {
     ...
     * why there is not a <CODE>set</CODE> method for the singleResponse property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link SingleResponseType }
     * 
     * 
     */
