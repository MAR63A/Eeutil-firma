...
public class RequestValidarFirmantes extends RequestConfigAfirma {

  private String firmaElectronica;
  private String datos;
  private String tipoFirma;

  public RequestValidarFirmantes(RequestConfigAfirma config, String firmaElectronica, String datos,
      String tipoFirma) {
