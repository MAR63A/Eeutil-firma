...
public class DSSResultConstantes {
  ...
  public static String DSS_MAJOR_REQUESTERERROR =
      "urn:oasis:names:tc:dss:1.0:resultmajor:RequesterError";

  public static String DSS_MAJOR_RESPONDERERROR =
      "urn:oasis:names:tc:dss:1.0:resultmajor:ResponderError";

  public static String DSS_MAJOR_INSUFFICIENTINFORMATION =
      "urn:oasis:names:tc:dss:1.0:resultmajor:InsufficientInformation";

  public static String DSS_MAJOR_VALIDSIGNATURE =
      "urn:afirma:dss:1.0:profile:XSS:resultmajor:ValidSignature";

  public static String DSS_MAJOR_INVALIDSIGNATURE =
  ...
  public static String DSS_MAJOR_PENDING =
  ...
  public static String DSS_MINOR_INCORRECTFORMAT =
      "urn:afirma:dss:1.0:profile:XSS:resultminor:SignatureFormat:IncorrectFormat";

  public static String DSS_MINOR_INCOMPLETEUPGRADEOP =
      "urn:afirma:dss:1.0:profile:XSS:resultminor:IncompleteUpgradeOperation";

  public static String DSS_MINOR_INCORRECTRETURNUPDATEDSIGNTYPE =
      "urn:afirma:dss:1.0:profile:XSS:resultminor:IncorrectUpdateSignatureType";

  public static String DSS_MINOR_UPDATEDSIGNTYPENOTPROVIDED =
