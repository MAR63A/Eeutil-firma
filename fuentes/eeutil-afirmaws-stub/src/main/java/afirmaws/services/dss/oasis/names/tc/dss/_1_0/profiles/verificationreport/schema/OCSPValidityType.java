...
@XmlType(name = "OCSPValidityType", propOrder = {"ocspIdentifier", "ocspValue", "ocspContent",
...
public class OCSPValidityType {
   ...
   * 
   * @return possible object is {@link OCSPContentType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link OCSPContentType }
   * 
   */
