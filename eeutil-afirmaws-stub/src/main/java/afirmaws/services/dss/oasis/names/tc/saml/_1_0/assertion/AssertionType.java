...
import afirmaws.services.dss.org.w3._2000._09.xmldsig.SignatureType;
...
public class AssertionType {
  ...
  @XmlElements({
      ...
      @XmlElement(name = "AuthorizationDecisionStatement",
          type = AuthorizationDecisionStatementType.class)})
   ...
   * 
   * @param value allowed object is {@link AdviceType }
   * 
   */
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link AuthenticationStatementType }
   * {@link StatementAbstractType } {@link AttributeStatementType }
   * {@link SubjectStatementAbstractType } {@link AuthorizationDecisionStatementType }
   * 
   * 
   */
