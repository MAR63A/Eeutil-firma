...
@XmlType(name = "CommitmentTypeIndicationType", propOrder = {"commitmentTypeId", "objectReference",
...
public class CommitmentTypeIndicationType {
   ...
   * there is not a <CODE>set</CODE> method for the objectReference property.
   * 
   * <p>
   ...
   * 
   * @return possible object is {@link CommitmentTypeQualifiersListType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CommitmentTypeQualifiersListType }
   * 
   */
