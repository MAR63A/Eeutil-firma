...
@XmlType(name = "SingleResponseType",
    propOrder = {"certID", "certStatus", "thisUpdate", "nextUpdate", "singleExtensions"})
public class SingleResponseType {
   ...
   * 
   * @return possible object is {@link SingleResponseType.CertID }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SingleResponseType.CertID }
   * 
   */
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "",
      propOrder = {"hashAlgorithm", "issuerNameHash", "issuerKeyHash", "serialNumber"})
