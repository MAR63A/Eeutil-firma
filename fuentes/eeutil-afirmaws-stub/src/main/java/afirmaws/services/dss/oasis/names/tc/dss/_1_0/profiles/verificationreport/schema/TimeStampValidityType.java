...
@XmlType(name = "TimeStampValidityType",
    propOrder = {"timeStampIdentifier", "formatOK", "timeStampContent", "messageHashAlg",
        "messageHashAlgUpToDate", "signatureOK", "certificatePathValidity"})
public class TimeStampValidityType {
   ...
   * 
   * @return possible object is {@link SignatureIdentifierType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignatureIdentifierType }
   * 
   */
   ...
   * 
   * @return possible object is {@link TstContentType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link TstContentType }
   * 
   */
