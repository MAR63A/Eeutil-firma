...
/**
 * <p>
 * Java class for IndividualSignatureReportType complex type.
 * 
 * <p>
...
@XmlType(name = "IndividualSignatureReportType",
    propOrder = {"signatureIdentifier", "result", "details"})
public class IndividualSignatureReportType {
  ...
  @XmlElement(name = "Result", namespace = "urn:oasis:names:tc:dss:1.0:core:schema",
      required = true)
