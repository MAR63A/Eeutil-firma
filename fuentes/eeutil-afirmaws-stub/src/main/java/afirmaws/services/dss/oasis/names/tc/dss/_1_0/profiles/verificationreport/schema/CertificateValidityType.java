...
import afirmaws.services.dss.org.w3._2000._09.xmldsig.X509IssuerSerialType;
...
@XmlType(name = "CertificateValidityType",
    propOrder = {"certificateIdentifier", "subject", "chainingOK", "validityPeriodOK",
        "extensionsOK", "certificateValue", "certificateContent", "signatureOK",
        "certificateStatus"})
public class CertificateValidityType {
   ...
   * 
   * @return possible object is {@link X509IssuerSerialType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link X509IssuerSerialType }
   * 
   */
   ...
   * 
   * @return possible object is {@link CertificateContentType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CertificateContentType }
   * 
   */
   ...
   * 
   * @return possible object is {@link CertificateStatusType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CertificateStatusType }
   * 
   */
