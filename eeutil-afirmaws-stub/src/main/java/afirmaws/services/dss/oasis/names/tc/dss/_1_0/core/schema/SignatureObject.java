...
@XmlType(name = "",
    propOrder = {"signature", "timestamp", "base64Signature", "signaturePtr", "other"})
...
public class SignatureObject {
   ...
   * 
   * @param value allowed object is {@link Base64Signature }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SignaturePtr }
   * 
   */
   ...
   * there is not a <CODE>set</CODE> method for the schemaRefs property.
   * 
   * <p>
