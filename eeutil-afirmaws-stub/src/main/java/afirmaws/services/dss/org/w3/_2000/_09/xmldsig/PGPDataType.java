...
public class PGPDataType {
  ...
  @XmlElementRefs({
      @XmlElementRef(name = "PGPKeyID", namespace = "http://www.w3.org/2000/09/xmldsig#",
          type = JAXBElement.class, required = false),
      @XmlElementRef(name = "PGPKeyPacket", namespace = "http://www.w3.org/2000/09/xmldsig#",
          type = JAXBElement.class, required = false)})
   ...
   * "PGPKeyPacket" is used by two different parts of a schema. See: line 0 of
   * http://www.w3.org/TR/xmldsig-core/xmldsig-core-schema.xsd line 0 of
