...
import afirmaws.services.dss.org.etsi.uri._01903.v1_3.ClaimedRolesListType;
 ...
 *         &lt;element name="CertifiedRoles" type="{urn:oasis:names:tc:dss:1.0:profiles:verificationreport:schema#}CertifiedRolesListType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SignerRoleType {
   ...
   * 
   * @return possible object is {@link ClaimedRolesListType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link ClaimedRolesListType }
   * 
   */
   ...
   * 
   * @return possible object is {@link CertifiedRolesListType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CertifiedRolesListType }
   * 
   */
