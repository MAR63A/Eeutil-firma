...
@XmlType(name = "CRLValidityType", propOrder = {"crlIdentifier", "crlValue", "crlContent",
...
public class CRLValidityType {
   ...
   * 
   * @return possible object is {@link CRLContentType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CRLContentType }
   * 
   */
