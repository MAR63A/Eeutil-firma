...
@WebService
public interface EeUtilFirmarUserNameTokenService {

  @WebMethod(operationName = "firmaFichero", action = "urn:FirmaFichero")
  @WebResult(name = "datosSalida", partName = "datosSalida")
  public DatosSalida firmaFichero(@WebParam(name = "datosEntrada") @XmlElement(required = true,
  ...
  @WebResult(name = "datosSalida", partName = "datosSalida")
  public DatosSalida firmaFicheroWithPropertie(@WebParam(name = "datosEntrada") @XmlElement(
      required = true, name = "datosEntrada") DatosEntradaFichero entrada);
}
