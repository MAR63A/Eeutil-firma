...
public class ProcessingDetails {
   ...
   * there is not a <CODE>set</CODE> method for the validDetail property.
   * 
   * <p>
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the indeterminateDetail property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the invalidDetail property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
