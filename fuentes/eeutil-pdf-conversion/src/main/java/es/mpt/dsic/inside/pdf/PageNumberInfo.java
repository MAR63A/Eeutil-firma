...
public class PageNumberInfo {
  ...
  private Integer numberLastPage;
  private Integer numberTotalPages;

  public Integer getNumberLastPage() {
    return numberLastPage;
  }

  public void setNumberLastPage(Integer numberLastPage) {
    this.numberLastPage = numberLastPage;
  }

  public Integer getNumberTotalPages() {
    return numberTotalPages;
  }

  public void setNumberTotalPages(Integer numberTotalPages) {
